...
export class Cari extends React.Component {
    constructor(props) {
      super(props);
  ...
  const slides = items.map((item,index) => {
    return (
      <CarouselItem
        ...
        key={item.src}
      >
        <h1 style={{marginLeft:"-500px"}}>{index+1}. {item.name}</h1>
        <img src={item.src} alt={item.altText} style={{height:"450px",width:'650px'}}/>
    ...
    >
      ...
      <CarouselControl direction="next" directionText="Next" onClickHandler={next} />
        ...
        <div className="row">
          ...
          <Colap data={items[activeIndex].benefits} id={activeIndex} text="Benefits" name="bene" id={activeIndex}  />
            
          </div> 
          <div className="col-md-6">
            <Colap data={items[activeIndex].preq} text="preq" name="prequ" id={activeIndex} />
          </div> 
